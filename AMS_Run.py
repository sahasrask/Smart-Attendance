...
def manually_fill():
    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            c1ear_enroll = tk.Button(MFW, text="Clear", command=remove_enr, fg="black", bg="pink", width=10,
                                     height=1,
                                     activebackground="Red", font=('times', 15, ' bold '))
            c1ear_enroll.place(x=690, y=100)

            c1ear_student = tk.Button(MFW, text="Clear", command=remove_student, fg="black", bg="pink", width=10,
                                      height=1,
                                      activebackground="Red", font=('times', 15, ' bold '))
    ...
    fill_manual_attendance = tk.Button(sb, text="Fill Attendance",command=fill_attendance, fg="white", bg="pink", width=20, height=2,
                       activebackground="Red", font=('times', 15, ' bold '))
...
def admin_panel():
    ...
    c0 = tk.Button(win, text="Clear", command=c00, fg="black", bg="pink", width=10, height=1,
                            activebackground="Red", font=('times', 15, ' bold '))
    c0.place(x=690, y=55)
...
lbl = tk.Label(window, text="Enter Enrollment", width=20, height=2, fg="black", bg="pink", font=('times', 15, ' bold '))
